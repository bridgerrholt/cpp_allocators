#ifndef BRH_CPP_ALLOCATORS_SRC_BRH_ALLOCATORS_WRAPPERS_ALLOCATOR_SINGLETON_H
#define BRH_CPP_ALLOCATORS_SRC_BRH_ALLOCATORS_WRAPPERS_ALLOCATOR_SINGLETON_H
